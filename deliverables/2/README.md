...
**GitHub Classroom Link:** https://classroom.github.com/a/-Kclbccx
...
that mock object in either the Room.java, Player.java, or CoffeeMakerQuest.java
...
1. Complete GradeScope **Deliverable 2 Coverage** questionnaire.  After having
   described the division of work, please upload screenshots of code coverage
stats **after** having completed the testing code, along with the
implementation code.  Please refer to [Exercise
2](/exercises/2#measuring-code-coverage) on how to create the screenshot.
